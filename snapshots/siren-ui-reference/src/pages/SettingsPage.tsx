        ...
        <div className="space-y-0">
          ...
          <div className="flex items-center justify-between py-3.5">
            <div>
              ...
              <p className="text-[11px] text-[#555] mt-0.5">Siren is optimized for dark UI</p>
            </div>
        ...
        <>
          ...
          <div className="siren-card p-6 glass-panel">
            ...
            <p className="text-sm text-[#888] leading-relaxed mb-4">
              Sellers earn <span className="text-white">{MARKETPLACE_CREATOR_SHARE_PERCENT}%</span> per sale. Siren retains{' '}
