    ...
    <div className="max-w-xl space-y-6">
      <div className="siren-card p-6 glass-panel">
        ...
        <p className="text-sm text-[#888] leading-relaxed mb-4">
          Zeus is the dedicated venue for voice-sales scripts inside agent workflows — buyers discover you here. On each
          sale you receive <span className="text-white">{MARKETPLACE_CREATOR_SHARE_PERCENT}%</span> after processing.
          Zeus retains {MARKETPLACE_PLATFORM_FEE_PERCENT}% for distribution, compliance review, and payments.
        </p>
