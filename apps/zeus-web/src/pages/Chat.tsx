  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'assistant',
      content: isSales
        ? "Hey! I'm your Zeus Growth coach. I can help you draft emails, handle objections, analyze your pipeline, and sharpen your pitch. What are you working on?"
        : "I'm your Zeus Guard assistant. I can show you call stats, manage your whitelist, configure personas, and review intercepted calls. How can I help?"
    },
  ]);
