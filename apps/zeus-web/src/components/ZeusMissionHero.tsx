...
export function ZeusMissionHero() {
  return (
    <section
      className="relative overflow-hidden rounded-2xl border border-teal-500/20 zeus-mesh-hero shadow-[0_0_0_1px_rgba(34,211,238,0.08),0_12px_48px_rgba(0,0,0,0.55)]"
    ...
    >
      ...
      <div className="relative px-5 py-6 md:px-8 md:py-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div className="max-w-xl space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full border border-teal-400/25 bg-teal-500/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.14em] text-teal-200/90">
            <Bolt className="w-3.5 h-3.5 text-zeus-surge" aria-hidden />
            Unified stack
          </div>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2 lg:justify-end lg:max-w-md">
          <Link
            to="/listen"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl zeus-cta-surge text-sm font-semibold shadow-lg"
          >
          ...
          <Link
            to="/target"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-violet-400/25 bg-violet-500/[0.07] text-sm font-medium text-violet-100 hover:bg-violet-500/12 transition-colors"
          >
          ...
          <Link
            to="/publish"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-amber-400/20 bg-amber-500/[0.06] text-sm font-medium text-amber-100/95 hover:bg-amber-500/10 transition-colors"
          >
